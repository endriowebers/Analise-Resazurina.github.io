...
lista_de_todos_os_plots_1 <- pmap(list(
...
lista_de_todos_os_plots_1 <- compact(lista_de_todos_os_plots)

# --- 4. MOSTRAR OS GRÁFICOS! ---
# Agora usamos subplot() para combinar e exibir todos os gráficos da lista
if (length(lista_de_todos_os_plots_1) > 0) {
  subplot(lista_de_todos_os_plots_1, nrows = ceiling(length(lista_de_todos_os_plots_1) / 3)) %>%
...
```{r}
lista_de_todos_os_plots_1[[1]]
lista_de_todos_os_plots_1[[2]]
lista_de_todos_os_plots_1[[3]]
```
